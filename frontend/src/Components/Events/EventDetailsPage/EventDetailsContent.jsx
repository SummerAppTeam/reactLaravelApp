      ...
      <div className="eventDetailContainer">
        ...
        <div className="eventExtra">
          <div className="eventContent">
            ...
            <ul>
              <li>
                🎶 Engaging live music and performances 🍽️ Delicious food and
                refreshing drinks
              </li>

              <li>
                🎉 Exciting activities for everyone 🤝 Friendly atmosphere and
                great company
              </li>

              <li>
                👨‍👩‍👧‍👦 Family friendly events 📅 Memorable experiences and lasting
                connections
              </li>
            </ul>
          </div>
        ...
        <div className="eventSafetyFaqContainer">
          <div className="eventSafety">
            ...
            <p>
              ...
              <br></br>
              <br></br>Clear emergency procedures are established and
              communicated to all attendees and staff to guarantee a quick and
              efficient response if needed. Our facilities are fully accessible
              to accommodate all guests, including those with mobility
              challenges or special needs. <br></br> <br></br>Additionally, we
              collaborate closely with local health authorities to stay updated
              on any new guidelines, making sure every aspect of your experience
              is comfortable, secure, and enjoyable from start to finish. Your
