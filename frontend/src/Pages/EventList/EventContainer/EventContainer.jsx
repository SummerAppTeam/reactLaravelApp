...
//   const lowToHigh = () => setEvents([...events].sort((a, b) => a.price - b.price));
//   const highToLow = () => setEvents([...events].sort((a, b) => b.price - a.price));
//   const sortAtoZ = () => setEvents([...events].sort((a, b) => a.name.localeCompare(b.name)));
//   const sortZtoA = () => setEvents([...events].sort((a, b) => b.name.localeCompare(a.name)));
...
//   return (
//     <div className={clsx("pageWrapper", darkMode ? "dark-theme" : "light-theme")}>
...
//                 highlights the rich and diverse culture of Finland.
//               </p>
//               <img
//                 src="https://images.pexels.com/photos/1703323/pexels-photo-1703323.jpeg"
//                 alt="Finland cultural event"
...
//                   if (value === "high") highToLow();
//                   if (value === "az") sortAtoZ();
//                   if (value === "za") sortZtoA();
//                 }}
//               >
//                 <option value="">Sort Events</option>
//                 <option value="low">Price: Low to High</option>
